...
try {
    ...
    $ch=curl_init('http://localhost/Shoppinglista/php/raderaAllaVaror.php');
    ...
    echo "<p class='info'>Test med POST</p>";
    raderaAlla($ch);
...
function raderaAlla($curlHandle) {
    ...
    if($status===200) {
        ...
        echo "<p class='error'>Kunder inte radera alla varor, status=$status istället för 200</p>";
    }
